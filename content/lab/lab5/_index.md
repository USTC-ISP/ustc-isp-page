...
本次实验围绕程序性能优化展开，包含图像卷积优化与 MoE Top-k 路由模拟两个任务。你需要在保证功能正确的前提下，提升程序的运行效率。

## 实验目的

在实验5-1中，你将优化一个 C 语言实现的图像卷积函数，理解缓存局部性、分支预测与循环开销对性能的影响。

而在实验5-2中，你将实现一个高效的 MoE Top-k 路由模拟器，初步掌握算法层面的优化方法。
